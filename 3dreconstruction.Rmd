...
```{r}
                # x    y   -z   1
XYZ <- matrix(c(  0,   1,0.01,  1, # persis di tengah
                  0,   1,   1,  1, # persis di tengah, agak ke depan
                 -1,   1,   1,  1, # depan, agak ke kiri
                  3,   1,   1,  1, # depan, lebih ke kanan
                  0,   2,   1,  1, # depan, atas
                  0,  -2,   1,  1, # depan, lebih ke bawah
                 -1,  -2,   1,  1, # depan, kiri atas
                  2,   5,   1,  1, # depan, kanan atas
                  0,   1,   5,  1, # persis di tengah, depan banget
                 -1,   1,   5,  1, # depan banget, agak ke kiri
                  3,   1,   5,  1, # depan banget, lebih ke kanan
                  0,   2,   5,  1, # depan banget, atas
                  0,  -2,   5,  1, # depan banget, lebih ke bawah
                 -1,  -2,   5,  1, # depan banget, kiri atas
                  2,   5,   5,  1),# depan banget, kanan atas
              ncol=4, byrow=TRUE)
